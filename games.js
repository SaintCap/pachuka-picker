/* ============================================================
   УСТАРЕЛО — этот файл больше не используется!
   ============================================================
   Список игр теперь хранится в Supabase (таблица `games`) и
   добавляется вручную через Supabase Table Editor — см. README.md
   и supabase_setup.sql.

   Файл оставлен только как справочный пример прежнего формата
   записи об игре. В index.html он больше не подключается.
   ============================================================ */
